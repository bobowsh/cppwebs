...
public:     // method of ordinary json object or json array
    ...
    CJson(const CJson* pJsonObject);
    CJson(const CJson& oJsonObject);
    virtual ~CJson();

    CJson& operator=(const CJson& oJsonObject);
    bool operator==(const CJson& oJsonObject) const;
...
public:     // method of ordinary json object
    ...
    CJson& operator[](const std::string& strKey);
    std::string operator()(const std::string& strKey) const;
	


    bool Get(const std::string& strKey, CJson& oJsonObject) const;
    ...
    bool Add(const std::string& strKey, const CJson& oJsonObject);
    ...
    bool Replace(const std::string& strKey, const CJson& oJsonObject);
...
public:     // method of json array
    int GetArraySize();
    CJson& operator[](unsigned int uiWhich);
    std::string operator()(unsigned int uiWhich) const;
    bool Get(int iWhich, CJson& oJsonObject) const;
    ...
    bool Add(const CJson& oJsonObject);
    ...
    bool AddAsFirst(const CJson& oJsonObject);
    ...
    bool Replace(int iWhich, const CJson& oJsonObject);
...
private:
    ...
    std::map<unsigned int, CJson*> m_mapJsonArrayRef;
    std::map<std::string, CJson*> m_mapJsonObjectRef;
};
